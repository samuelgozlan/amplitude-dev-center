...
The Exposures without Assignments chart appears in the **Monitor** section and queries for the cumulative number of unique users who have performed an exposure event without a corresponding assignment event within each day. 
